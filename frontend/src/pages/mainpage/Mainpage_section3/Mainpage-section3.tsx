    ...
    return(
        <div className="section3">
            ...
            <div className="popis-a-kocarek">
                <p>Dvoumístný multifunkční vozík za kolo a kočárek pro kondiční běh v jednom.<br /><br />Thule Chariot Lite 1 Agave - výlet do světa snů pro nejmenší, nabízející bezpečí, pohodlí a špičkový design.<br /><br />Thule Chariot Lite 1 Agave 2021 je jako kouzelný kompas, který vaše rodinná dobrodružství směřuje k nekonečným cyklistickým zážitkům. S elegancí designu a špičkovou funkcionalitou vám tento dětský vozík otevírá dveře do světa vzrušení a pohodlí na každém kilometru. Lze si půjčit miminkovník, který je určen pro děti od 1-10 měsíců. Je vhodný pro zimní i letní aktiviity, jelikož půjčujeme lyžařské a cyklsistické příslušenství.</p>
